...
Every implementation — real CLI controllers (driven by scripted fake CLIs)
and ``FakeAgentController`` — must satisfy these expectations.
        ...
        if request.param == "codex":
            steps = (
                [
                    ...
                    codex_cli.error_item("boom"),
                    codex_cli.turn_failed("boom"),
                ]
                if error
